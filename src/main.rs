...
impl App {
    ...
    fn draw(&self, frame: &mut Frame) {
        ...
        for i in 1..5 {
            ...
            if i == 2 { render_area = slot2; }
            else if i == 3 { render_area = slot3; }
            else if i == 4 { render_area = slot4; }
...
fn main() -> io::Result<()> {
    ...
    let today = "TODO: Put something useful in here (and maybe also in Raijin's place)".to_string(); //nws_periods[0].detailed_forecast.clone();
